...
describe('CSSPropertyOperations', function() {
  ...
  it('should create markup for simple css', function() {
  ...
  it('should ignore undefined css', function() {
    expect(CSSPropertyOperations.createMarkupForStyles({
  ...
  it('should ignore null css', function() {
    expect(CSSPropertyOperations.createMarkupForStyles({
  ...
  it('should return null for no css', function() {
    expect(CSSPropertyOperations.createMarkupForStyles({
      backgroundColor: null,
      display: null
    })).toBe(null);
  ...
  it('should automatically append `px` to relevant css', function() {
    expect(CSSPropertyOperations.createMarkupForStyles({
      left: 0,
      margin: 16,
      opacity: 0.5,
  ...
  it('should not append `px` to css that might need a number', function() {
  ...
  it('should set style attribute when css exist', function() {
    var styles = {
      backgroundColor: '#000',
      display: 'none'
    };
  ...
  it('should not set style attribute when no css exist', function() {
    var styles = {
      backgroundColor: null,
      display: null
    };
