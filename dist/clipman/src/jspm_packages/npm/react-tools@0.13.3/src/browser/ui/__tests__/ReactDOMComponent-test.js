...
describe('ReactDOMComponent', function() {
  ...
  describe('updateDOM', function() {
    ...
    it("should update css when mutating style object", function() {
    ...
    it("should update css if initially null", function() {
      var styles = null;
      var container = document.createElement('div');
      React.render(<div style={styles} />, container);
    ...
    it("should update css if updated to null multiple times", function() {
      var styles = null;
      var container = document.createElement('div');
      React.render(<div style={styles} />, container);
    ...
    it("should clear all the css when removing 'style'", function() {
      var styles = {display: 'none', color: 'red'};
      var container = document.createElement('div');
      React.render(<div style={styles} />, container);
    ...
    it("should update css when 'style' changes from null to object", function() {
      var container = document.createElement('div');
  ...
  describe('mountComponent', function() {
    ...
    it("should validate against invalid css", function() {
      expect(function() {
